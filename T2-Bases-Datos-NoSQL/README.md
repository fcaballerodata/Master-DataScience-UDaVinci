# 🗄️ Bases de Datos y Bases de Datos NoSQL (BDNS)

**Trimestre 2 — Universidad DaVinci**  
📅 Junio – Agosto 2026 | 10 semanas | 13 Unidades Didácticas

---

## 📋 Descripción

Asignatura que cubre desde los fundamentos del modelado de bases de datos relacionales hasta las arquitecturas NoSQL modernas. Incluye práctica con SQL Server, Oracle y MongoDB como sistemas gestores principales.
...
| Componente | Peso |
|---|---|
| Autoevaluaciones (13 × 1 por unidad) | 15% |
| Foros de discusión (5 foros) | 20% |
| Actividad Práctica 1 | 20% |
| Actividad Práctica 2 | 20% |
| Examen Final | 25% |
